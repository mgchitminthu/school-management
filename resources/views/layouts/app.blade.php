...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light shadow-sm" style="background: linear-gradient(90deg, rgb(183, 215, 240)  ,rgb(247, 218, 240))">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a href="{{url("/enrollments")}}" class="nav-link">Enrollments</a>
                        </li>
                        <li class="nav-item">
